...
const UploadIcon = ({ fillColor, size }: IconProps) => {
  return (
    <>
      <svg
      ...
      >
        ...
        <path
          ...
          fill={fillColor ? fillColor : "#5ECBEC"}
        />
        <path
          d="M17.9302 8.81048C18.8802 8.82048 20.2002 8.82048 21.3302 8.82048C21.9002 8.82048 22.2002 8.15048 21.8002 7.75048C20.3602 6.30048 17.7802 3.69048 16.3002 2.21048C15.8902 1.80048 15.1802 2.08048 15.1802 2.65048V6.14048C15.1802 7.60048 16.4202 8.81048 17.9302 8.81048Z"
          fill={fillColor ? fillColor : "#5ECBEC"}
        />
      </svg>
    </>
